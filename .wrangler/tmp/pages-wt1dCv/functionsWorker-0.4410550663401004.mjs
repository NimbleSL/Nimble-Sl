...
- Approachable, smart, and professional. You do NOT invent facts. If asked something outside this scope, you politely say you don't know and direct them to sales@nimblesl.com.`;
    ...
    const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        // Fast, efficient model for simple Q&A
    ...
    return new Response(response.body, {
      ...
      headers: {
        ...
        // Allow Angular dev server to hit this endpoint
      }
    });
  } catch (error) {
...
// ../.wrangler/tmp/pages-wt1dCv/functionsRoutes-0.13405320757531491.mjs
var routes = [
  {
    routePath: "/api/chat",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-whyF0m/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-whyF0m/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4410550663401004.mjs.map
