...
export const post: BlogPost = {
  ...
  title: `How to Write a Software Requirements Document (With Template)`,
...
![How to Write a Software Requirements Document (With Template) data pipeline flow and architecture details](/blog/inline/software-requirements-document-diagram.svg)
