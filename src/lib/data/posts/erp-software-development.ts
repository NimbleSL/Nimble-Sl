...
export const post: BlogPost = {
  ...
  title: `ERP Software Development: Modules, Cost, and Implementation Guide`,
...
![ERP Software Development: Modules, Cost, and Implementation Guide data pipeline flow and architecture details](/blog/inline/erp-software-development-diagram.svg)
