...
export const post: BlogPost = {
  slug: 'working-with-dev-agency',
  title: `From Idea to Launch: What to Expect When Working With a Dev Agency`,
...
![From Idea to Launch: What to Expect When Working With a Dev Agency data pipeline flow and architecture details](/blog/inline/working-with-dev-agency-diagram.svg)
