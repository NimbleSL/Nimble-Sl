...
export const post: BlogPost = {
  ...
  title: `Why Your Software Project Will Fail (And How to Prevent It)`,
...
![Why Your Software Project Will Fail (And How to Prevent It) data pipeline flow and architecture details](/blog/inline/why-software-projects-fail-diagram.svg)
